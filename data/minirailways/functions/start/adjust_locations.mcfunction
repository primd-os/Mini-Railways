...
execute as @e[type=marker,x=0,tag=mr.ToRemove,tag=mr.Source] at @s run summon marker ~ ~ ~ {Tags:["mr.ToRemove", "mr.new", "mr.Source"]}
execute as @e[type=marker,x=0,tag=mr.ToRemove,tag=mr.Destination] at @s run summon marker ~ ~ ~ {Tags:["mr.ToRemove", "mr.new", "mr.Destination"]}
