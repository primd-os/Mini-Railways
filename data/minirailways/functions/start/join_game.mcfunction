...
give @s written_book{pages:['["",{"text":"How to play Mini Railways","underlined":true},{"text":"\\nIn Mini Railways your goal is to move items from the source to the pickup of the same color. You accomplish this using hopper minecarts. For every source/pickup pair you recieve 12 emeralds you can spend in the shop on various items.","color":"reset"}]'],title:"How To Play",author:Devon7925,display:{Lore:["A description of how to play Mini Railways."]}}
team join mr.Team @s